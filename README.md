...
* The easiest approach is to use the AWS Serverless Application Repository (SAR) to install lambda-cache from this link: [Deploy now!](https://serverlessrepo.aws.amazon.com/applications/us-east-1/484660614037/lambda-cache)
